...
# Development email backend: prints mails to the console. In production, set
# a real SMTP backend and secure credentials via environment variables.
if os.getenv('ENVIRONMENT') == 'development':
    ...
    DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'allan@finance_alert.com')
else:
